...
#define IPT4_REST_FILE "/tmp/ipt4_rest_file"
#define IPT6_REST_FILE "/tmp/ipt6_rest_file"
...
//  }
  ...
  if  (  (strcmp(arg1,"init")==0)  )
  {
	...
	// Mos 2018/08/27, fix [OC-512] 80 port should not be open on IPV6 WAN address if "Remote management"
...
int len;
// Mos 2018/08/27, fix [OC-512] 80 port should not be open on IPV6 WAN address if "Remote management"
#if 0//(defined BCA_HNDROUTER) || (defined CONFIG_QCA_SDK)
