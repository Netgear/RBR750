	...
	else
	{
		for(i=0; i<(int)num_options; i++)
		{
			...
			case UPNPMINISSDPDSOCKET:
				...
				break;
#if 1
/*Foxconn modify by Mos: add for upnp Advertisement TTL setting 2012/10/30 start*/
			case UPNPADV_TTL:
				adv_ttl = atoi(ary_options[i].value);
				break;
/*Foxconn modify by Mos: add for upnp Advertisement TTL setting 2012/10/30 end*/
#endif
			default:
