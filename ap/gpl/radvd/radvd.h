...
struct Interface {
	...
	struct AdvDNSSL 	*AdvDNSSLList;		//Patch from v1.15
...
void dnssl_init_defaults(struct AdvDNSSL *, struct Interface *);	//Patch from v1.15
...
int check_dnssl_presence(struct AdvDNSSL *, const char *);		//Patch from v1.15
