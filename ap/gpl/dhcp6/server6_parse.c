...
union YYSTYPE
{
#line 117 "server6_parse.y" /* yacc.c:355  */
...
{
       0,   127,   127,   129,   133,   134,   135,   136,   140,   166,
     207,   209,   213,   214,   215,   216,   220,   238,   275,   277,
     281,   282,   283,   284,   285,   286,   287,   291,   292,   296,
     318,   331,   356,   358,   362,   363,   364,   365,   366,   370,
     413,   508,   518,   520,   524,   525,   526,   527,   528,   529,
     530,   534,   559,   583,   615,   616,   620,   628,   629,   633,
     639,   643,   647,   651,   662,   663,   667,   681,   689,   693,
     701,   709,   713,   717,   724,   744,   748,   756,   765,   776,
     783,   790,   797,   804,   807,   810,   816,   817,   821,   828,
     829,   833,   840,   841,   845,   851,   882,   883,   887,   896,
     905,   921,   937,   951,   955,   962
};
#endif
...
yyreduce:
  ...
  switch (yyn)
    {
        case 8:
#line 141 "server6_parse.y" /* yacc.c:1646  */
    {
		if (linklist) {
		...
		dprintf2(LOG_DEBUG, "interface definition for %s is ok", ifnetwork->name);
...
#line 1509 "y.tab.c" /* yacc.c:1646  */
  ...
  case 9:
#line 167 "server6_parse.y" /* yacc.c:1646  */
    {
		...
		while (temp_if)
		{
			...
			{
				dprintf2(LOG_ERR, "duplicate interface definition for %s",
					temp_if->name);
				ABORT;
			}
		...
		if (get_linklocal(ifnetwork->name, &ifnetwork->linklocal) < 0) {
			dprintf2(LOG_ERR, "get device %s linklocal failed", ifnetwork->name);
		}
		...
		if (if_nametoindex(ifnetwork->name) == 0) {
			dprintf2(LOG_ERR, "this device %s doesn't exist.", (yyvsp[0].str));
		}
...
#line 1553 "y.tab.c" /* yacc.c:1646  */
  ...
  case 16:
#line 221 "server6_parse.y" /* yacc.c:1646  */
    {
		if (poollist) {
...
#line 1572 "y.tab.c" /* yacc.c:1646  */
  ...
  case 17:
#line 239 "server6_parse.y" /* yacc.c:1646  */
    {
		...
		while (temp_sub) {
			...
			{
				dprintf2(LOG_ERR, "duplicate link definition for %s", (yyvsp[0].str));
				ABORT;
			}
...
#line 1611 "y.tab.c" /* yacc.c:1646  */
  ...
  case 29:
#line 297 "server6_parse.y" /* yacc.c:1646  */
    {
		struct v6addrlist *temprelay;
		if (!link) {
			dprintf2(LOG_ERR, "relay must be defined under link");
			ABORT;
		}
...
#line 1634 "y.tab.c" /* yacc.c:1646  */
  ...
  case 30:
#line 319 "server6_parse.y" /* yacc.c:1646  */
    {
		if (currentgroup) 
...
#line 1648 "y.tab.c" /* yacc.c:1646  */
  ...
  case 31:
#line 332 "server6_parse.y" /* yacc.c:1646  */
    {
		if (!link) {
			dprintf2(LOG_ERR, "pooldef must be defined under link");
			ABORT;
		}
		pool = (struct pool_decl *)malloc(sizeof(*pool));
		if (pool == NULL) {
			dprintf2(LOG_ERR, "fail to allocate memory");
			ABORT;
		}
...
#line 1675 "y.tab.c" /* yacc.c:1646  */
  ...
  case 39:
#line 371 "server6_parse.y" /* yacc.c:1646  */
    {
		struct v6prefix *v6prefix, *v6prefix0;
		struct v6addr *prefix;
		if (!link) {
			dprintf2(LOG_ERR, "prefix must be defined under link");
			ABORT;
		}
		...
		if ((yyvsp[-1].num) > 128 || (yyvsp[-1].num) < 0) {
			dprintf2(LOG_ERR, "invalid prefix length in line %d", num_lines);
			ABORT;
		}
		...
		for (v6prefix0 = link->prefixlist; v6prefix0; v6prefix0 = v6prefix0->next) {
			if (IN6_ARE_ADDR_EQUAL(prefix, &v6prefix0->prefix.addr) && 
				...
				dprintf2(LOG_ERR, "duplicated prefix defined within same link");
				ABORT;
			}
		}
		/* check the assigned prefix is not reserved pv6 addresses */
		if (IN6_IS_ADDR_RESERVED(prefix)) {
			dprintf2(LOG_ERR, "config reserved prefix");
			ABORT;
		}
...
#line 1719 "y.tab.c" /* yacc.c:1646  */
  ...
  case 40:
#line 414 "server6_parse.y" /* yacc.c:1646  */
    {
		struct v6addrseg *seg, *temp_seg;
		struct v6addr *prefix1, *prefix2;
		if (!link) {
			dprintf2(LOG_ERR, "range must be defined under link");
			ABORT;
		}
		...
		if (!prefix1 || !prefix2) {
			dprintf2(LOG_ERR, "address range defined error");
			ABORT;
		}
		...
		if (IN6_IS_ADDR_RESERVED(&seg->max) || IN6_IS_ADDR_RESERVED(&seg->max)) {
			dprintf2(LOG_ERR, "config reserved ipv6address");
			ABORT;
		}
			...
			for (; temp_seg; temp_seg = temp_seg->next) { 
				...
				if (prefix1->plen == temp_seg->prefix.plen) {
					    ...
					    || ipv6addrcmp(&seg->max, &temp_seg->min) < 0)) {
		   				dprintf2(LOG_ERR, "overlap range addr defined");
		   				ABORT;
					}
				}
...
#line 1815 "y.tab.c" /* yacc.c:1646  */
  ...
  case 41:
#line 509 "server6_parse.y" /* yacc.c:1646  */
    {
...
#line 1827 "y.tab.c" /* yacc.c:1646  */
  ...
  case 51:
#line 535 "server6_parse.y" /* yacc.c:1646  */
    {
		struct scope *groupscope;
		groupscope = (struct scope *)malloc(sizeof(*groupscope));
		if (groupscope == NULL) {
			dprintf2(LOG_ERR, "group memory allocation failed");
			ABORT;
		}
...
#line 1853 "y.tab.c" /* yacc.c:1646  */
  ...
  case 52:
#line 560 "server6_parse.y" /* yacc.c:1646  */
    {
		struct host_decl *temp_host = hostlist;
		while (temp_host)
		{
			if (temp_host->iaidinfo.iaid == host->iaidinfo.iaid) {
				dprintf2(LOG_ERR, "duplicated host %d redefined", 
					host->iaidinfo.iaid);
				ABORT;
			}
...
#line 1877 "y.tab.c" /* yacc.c:1646  */
  ...
  case 53:
#line 584 "server6_parse.y" /* yacc.c:1646  */
    {
		struct host_decl *temp_host = hostlist;
		while (temp_host)
		{
			if (!strcmp(temp_host->name, (yyvsp[0].str))) {
				dprintf2(LOG_ERR, "duplicated host %s redefined", (yyvsp[0].str));
				ABORT;
			}
			temp_host = temp_host->next;
		}
...
#line 1910 "y.tab.c" /* yacc.c:1646  */
  ...
  case 56:
#line 621 "server6_parse.y" /* yacc.c:1646  */
    {
		if (host == NULL) {
			dprintf2(LOG_DEBUG, "duid should be defined under host decl");
			ABORT;
		}
...
#line 1922 "y.tab.c" /* yacc.c:1646  */
  ...
  case 59:
#line 634 "server6_parse.y" /* yacc.c:1646  */
    {
	}
#line 1929 "y.tab.c" /* yacc.c:1646  */
  ...
  case 60:
#line 640 "server6_parse.y" /* yacc.c:1646  */
    {
...
#line 1937 "y.tab.c" /* yacc.c:1646  */
  ...
  case 61:
#line 644 "server6_parse.y" /* yacc.c:1646  */
    {
...
#line 1945 "y.tab.c" /* yacc.c:1646  */
  ...
  case 63:
#line 652 "server6_parse.y" /* yacc.c:1646  */
    {
		if (host == NULL) {
			dprintf2(LOG_DEBUG, "iaid should be defined under host decl");
			ABORT;
		}
...
#line 1957 "y.tab.c" /* yacc.c:1646  */
  ...
  case 66:
#line 668 "server6_parse.y" /* yacc.c:1646  */
    {
		if (host == NULL) {
			dprintf2(LOG_DEBUG, "address should be defined under host decl");
			ABORT;
		}
		...
		if (hash_add(host_addr_hash_table, &((yyvsp[0].dhcp6addr)->addr), (yyvsp[0].dhcp6addr)) != 0) {
			dprintf2(LOG_ERR, "%s" "hash add lease failed for %s",
...
#line 1975 "y.tab.c" /* yacc.c:1646  */
  ...
  case 67:
#line 682 "server6_parse.y" /* yacc.c:1646  */
    {
		if (host == NULL) {
			dprintf2(LOG_DEBUG, "prefix should be defined under host decl");
			ABORT;
		}
...
#line 1987 "y.tab.c" /* yacc.c:1646  */
  ...
  case 69:
#line 694 "server6_parse.y" /* yacc.c:1646  */
    {
...
#line 1996 "y.tab.c" /* yacc.c:1646  */
  ...
  case 70:
#line 702 "server6_parse.y" /* yacc.c:1646  */
    {
...
#line 2005 "y.tab.c" /* yacc.c:1646  */
  ...
  case 71:
#line 710 "server6_parse.y" /* yacc.c:1646  */
    {
...
#line 2021 "y.tab.c" /* yacc.c:1646  */
  ...
  case 73:
#line 718 "server6_parse.y" /* yacc.c:1646  */
    {
...
#line 2029 "y.tab.c" /* yacc.c:1646  */
  ...
  case 74:
#line 725 "server6_parse.y" /* yacc.c:1646  */
    {
		struct dhcp6_addr *temp;
		temp = (struct dhcp6_addr *)malloc(sizeof(*temp));
		if (temp == NULL) {
			dprintf2(LOG_ERR, "v6addr memory allocation failed");
			ABORT;
		}
...
#line 2050 "y.tab.c" /* yacc.c:1646  */
  ...
  case 76:
#line 749 "server6_parse.y" /* yacc.c:1646  */
    {		
		if (!currentscope) { 
...
#line 2062 "y.tab.c" /* yacc.c:1646  */
  ...
  case 77:
#line 757 "server6_parse.y" /* yacc.c:1646  */
    {		
		if (!currentscope) {
			currentscope = push_double_list(currentscope, &globalgroup->scope);
			if (currentscope == NULL)
...
#line 2087 "y.tab.c" /* yacc.c:1646  */
  ...
  case 79:
#line 777 "server6_parse.y" /* yacc.c:1646  */
    {
		if (allow) 
...
#line 2098 "y.tab.c" /* yacc.c:1646  */
  ...
  case 80:
#line 784 "server6_parse.y" /* yacc.c:1646  */
    {
		if (allow) 
...
#line 2109 "y.tab.c" /* yacc.c:1646  */
  ...
  case 81:
#line 791 "server6_parse.y" /* yacc.c:1646  */
    {
		if (allow) 
...
#line 2120 "y.tab.c" /* yacc.c:1646  */
  ...
  case 82:
#line 798 "server6_parse.y" /* yacc.c:1646  */
    {
		if (allow) 
...
#line 2131 "y.tab.c" /* yacc.c:1646  */
  ...
  case 83:
#line 805 "server6_parse.y" /* yacc.c:1646  */
    {
	}
#line 2138 "y.tab.c" /* yacc.c:1646  */
  ...
  case 84:
#line 808 "server6_parse.y" /* yacc.c:1646  */
    {
	}
#line 2145 "y.tab.c" /* yacc.c:1646  */
  ...
  case 85:
#line 811 "server6_parse.y" /* yacc.c:1646  */
    {
	}
#line 2152 "y.tab.c" /* yacc.c:1646  */
  ...
  case 88:
#line 822 "server6_parse.y" /* yacc.c:1646  */
    {
...
#line 2161 "y.tab.c" /* yacc.c:1646  */
  ...
  case 91:
#line 834 "server6_parse.y" /* yacc.c:1646  */
    {
...
#line 2170 "y.tab.c" /* yacc.c:1646  */
  ...
  case 94:
#line 846 "server6_parse.y" /* yacc.c:1646  */
    {
...
#line 2179 "y.tab.c" /* yacc.c:1646  */
  ...
  case 95:
#line 852 "server6_parse.y" /* yacc.c:1646  */
    {
		...
		if (currentscope->scope->dnslist.domainlist == NULL) {
			...
			dprintf2(LOG_DEBUG, "add domain name %s", domainname->name);
		} else {
			for (temp = currentscope->scope->dnslist.domainlist; temp;
			     temp = temp->next) {
				if (temp->next == NULL) {
					dprintf2(LOG_DEBUG, "add domain name %s", 
						domainname->name);
...
#line 2211 "y.tab.c" /* yacc.c:1646  */
  ...
  case 98:
#line 888 "server6_parse.y" /* yacc.c:1646  */
    {
		if (!currentscope) {
			currentscope = push_double_list(currentscope, &globalgroup->scope);
			if (currentscope == NULL)
...
#line 2224 "y.tab.c" /* yacc.c:1646  */
  ...
  case 99:
#line 897 "server6_parse.y" /* yacc.c:1646  */
    {	
		if (!currentscope) {
			currentscope = push_double_list(currentscope, &globalgroup->scope);
			if (currentscope == NULL)
...
#line 2237 "y.tab.c" /* yacc.c:1646  */
  ...
  case 100:
#line 906 "server6_parse.y" /* yacc.c:1646  */
    {
		if (!currentscope) {
			currentscope = push_double_list(currentscope, &globalgroup->scope);
			if (currentscope == NULL)
...
#line 2257 "y.tab.c" /* yacc.c:1646  */
  ...
  case 101:
#line 922 "server6_parse.y" /* yacc.c:1646  */
    {
		if (!currentscope) {
			currentscope = push_double_list(currentscope, &globalgroup->scope);
			if (currentscope == NULL)
...
#line 2277 "y.tab.c" /* yacc.c:1646  */
  ...
  case 102:
#line 938 "server6_parse.y" /* yacc.c:1646  */
    {
		if (!currentscope) {
			currentscope = push_double_list(currentscope, &globalgroup->scope);
			if (currentscope == NULL)
		...
		if ((yyvsp[-1].num) < 0 || (yyvsp[-1].num) > 255)
			dprintf2(LOG_ERR, "%s" "bad server preference number", FNAME);
...
#line 2292 "y.tab.c" /* yacc.c:1646  */
  ...
  case 103:
#line 952 "server6_parse.y" /* yacc.c:1646  */
    {
...
#line 2300 "y.tab.c" /* yacc.c:1646  */
  ...
  case 104:
#line 956 "server6_parse.y" /* yacc.c:1646  */
    {
...
#line 2308 "y.tab.c" /* yacc.c:1646  */
  ...
  case 105:
#line 963 "server6_parse.y" /* yacc.c:1646  */
    {
...
#line 968 "server6_parse.y" /* yacc.c:1906  */
...
{
	cleanup();
	dprintf2(LOG_ERR, "%s in line %d: %s ", msg, num_lines, sfyytext);
}
