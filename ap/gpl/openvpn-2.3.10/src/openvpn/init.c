...
int ambitWriteLog(int type, char *ip)
{
    char foxconnLogCmd[512] = "";
    char *LOGCOMMAND = "/usr/sbin/log_cli";
    char *SERVICE = "VPN_SERVICE";

    sprintf(foxconnLogCmd, "%s %s %d %s", LOGCOMMAND, SERVICE, type, ip);
    system(foxconnLogCmd); 
    return 0;
}
