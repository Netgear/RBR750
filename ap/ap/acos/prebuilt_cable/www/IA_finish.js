...
function loadSettings()
{
    ...
    var cf = document.forms[0];
     if("IA_finish" == cf.current_page.value)
     {
        ...
        {
            document.getElementById("ca_15_log").innerHTML = "<%3373%>";
            document.getElementById("24g_title").innerHTML = "<b><%3374%></b>";
            document.getElementById("5g_title").innerHTML = "<b><%3375%></b>";
            document.getElementById("ca_15_log_3").innerHTML = "<%3376%>";
        }
    }
    if("1" == cf.mode.value)
    {
