...
function ungrayout_applybtn(ButtonName)
{
    ...
    selectedButton.attr('class', 'button-apply2');
...
function grayout_cancelbtn(ButtonName)
{
    var selectedButton=$('#'+ButtonName);
    selectedButton.attr('class', 'button-cancel');
    selectedButton.attr('disabled', true);
}

function ungrayout_cancelbtn(ButtonName)
{
    var selectedButton=$('#'+ButtonName);
    selectedButton.attr('class', 'button-cancel');
    selectedButton.attr('disabled', false);
...
function change_size()
{
    ...
    $('.button_zone').css("width", width-27);
    ...
    if(document.getElementById("topframe")) {    
        ...
        $('.scroll-pane').css("height", height-310); 
    ...
    } else if($('ul.tabs').length) {
        $('.subhead2-table').css("height", height-70);
        $('.scroll-pane').css("height", height-70); 
    } else {
        $('.subhead2-table').css("height", height-75);
        $('.scroll-pane').css("height", height-75); 
    }
    
    $('.subhead2-bottom').css("width", width-30);
    if(sep_border2_num==1) {
    ...
    if(get_browser()=="Firefox"|| get_browser()=="Netscape") { 
	    ...
	    $('.bas-help-frame-div').css("top", height-224);
            $('.help-frame-div').css("top", height-224);
	}
    }    
    else {
        if(sep_border2_num==1) {
        ...
        } else if(sep_border_num==0) {
            $('.bas-help-frame-div').css("top", height-199);
            $('.help-frame-div').css("top", height-199);
        } else if($('ul.tabs').length) {
            $('.bas-help-frame-div').css("top", height-194);
            $('.help-frame-div').css("top", height-194);
        } else {            
            $('.bas-help-frame-div').css("top", height-227);
            $('.help-frame-div').css("top", height-227);
        }
    }
    if($("input[name=help-frame-div_magic_top]").length)
        $('.help-frame-div').css("top", parseInt($('.help-frame-div').css("top"))+parseInt($("input[name=help-frame-div_magic_top]").val()));
...
function subpage_resize()
{
    ...
    if(is_double)
    {
        page_contain_width = page_contain_width - 10 > 735 ? page_contain_width - 10 : 735;
        page_contain_height = page_contain_height - 10> 510+adjustPageHeight ? page_contain_height - 10 : 510+adjustPageHeight;
    }
     
    $('.basic-menu').css("height", page_contain_height);         

    var page_width = page_contain_width - 10;
...
function activeInputBox(inputName)
{
    if($(inputName).hasClass("non-active-val2"))
    {
        $(inputName).addClass('active');
        $(inputName).removeClass('non-active-val2');
    }
    if($(inputName).hasClass("non-active-val"))
    {
        $(inputName).addClass('active');
        $(inputName).removeClass('non-active-val');
    }
} 
    
function nonActiveInputBox(inputName, textId)
{
    if($(inputName).hasClass("active"))
    {
        if(document.getElementById(textId).value =="")
        {
            $(inputName).addClass('non-active-val2');
            $(inputName).removeClass('active');
        }
        else
            $(inputName).addClass('non-active-val');
    }
}

function nonActiveAllInputBox(inputName)
{
    if($(inputName).hasClass("active"))
    {
        $(inputName).addClass('non-active-val2');
