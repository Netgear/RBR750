...
var StartChannel = new Array(<%3364%>);
var FinishChannel = new Array(<%3365%>);
...
var curr_region = "<%20%>"
var curr_channel_5g_value = "<%3326%>"
var curr_channel_2g_value = "<%1937%>"
...
function setOpMode_24g_psr()
{
    ...
    if ((sec_type_2G == "None") || (sec_type_2G == "WPA2-PSK")|| (sec_type_2G == "WPA-AUTO-PSK"))
    {
        ...
        cf.opmode.options[0].text = "<%3369%>";
        cf.opmode.options[1].text = "<%3370%>";
