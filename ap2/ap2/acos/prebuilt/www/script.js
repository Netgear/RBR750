    ...
    function buttonFilter()
    {
        ...
        for(i=0;i<buttonElements.length;i++)
        {
            ...
            {
                if((buttonElements[i].name!=document.forms["mainForm"].buttonHit.value))
                    buttonElements[i].disabled=1;
                else
                {
//                    buttonElements[i].value=document.forms["mainForm"].buttonValue.value;
...
{
    if (parent.load_page && parent.load_page == 1)
        return false;
    ...
    if( !parent.$('#'+subtitle).hasClass('SubMenuDisable')
        && !parent.$('#'+subtitle).hasClass('SubMenuLargeDisable'))
    {  
...
function subpage_resize()
{
    ...
    var page_contain_height = document.documentElement.clientHeight-190 > 440+adjustPageHeight ? document.documentElement.clientHeight-190 : 440+adjustPageHeight;
    ...
    if(is_double)
    {
        ...
        page_contain_height = page_contain_height - 50> 440+adjustPageHeight ? page_contain_height - 50 : 440+adjustPageHeight;
    }
