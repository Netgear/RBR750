...
function loadSettings()
{
	...
	var daisychainEnableForm = document.forms["daisychainEnableForm"];
    ...
    */
	...
	if(daisychainEnableForm.enable_backhaul_ap.value == "1")
		daisychainEnableForm.action_daisychain_enable.checked = true;
	else
		daisychainEnableForm.action_daisychain_enable.checked = false;
        
	if(HigherRoamingAggresiveForm.higher_roaming_aggresive.value == "1")
		HigherRoamingAggresiveForm.action_roaming_aggresive.checked = true;
	else
		HigherRoamingAggresiveForm.action_roaming_aggresive.checked = false; 
    
	if(SystemWpsForm.system_wps.value == "1")
		SystemWpsForm.action_system_wps.checked = true;
	else
		SystemWpsForm.action_system_wps.checked = false;      

	if(SystemDfsForm.system_dfs.value == "1")
		SystemDfsForm.action_system_dfs.checked = true;
	else
		SystemDfsForm.action_system_dfs.checked = false; 

	if(AirtimeFairnessForm.enable_atf_qca.value == "1")
		AirtimeFairnessForm.action_AirtimeFairness.checked = true;
	else
		AirtimeFairnessForm.action_AirtimeFairness.checked = false; 
	/*
