...
#define GSO_MAX_SEGS		65535
	...
	/* bdda wklin added start, 11/06/2008 */
    ...
    /* bdda wklin added start, 02/08/2010 */
    ...
    /* bdda wklin added end, 02/08/2010 */
    /* bdda wklin added start, 05/14/2010 */
    ...
    /* bdda wklin added end, 05/14/2010 */
    /* bdda add start, Max Ding, 10/17/2011 */
    #define BR_LOCAL_OUT_ARP_FILTER    512    /* filter arp packets @ bridge */
    /* bdda add end, Max Ding, 10/17/2011 */
    unsigned    acos_flags;
    /* bdda wklin added end, 11/06/2008 */	
#endif
};
