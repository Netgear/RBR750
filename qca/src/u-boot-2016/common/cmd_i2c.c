...
static int do_i2c_led(cmd_tbl_t *cmdtp, int flag, int argc, char * const argv[])
{
    unsigned int led_color; 
    unsigned int led_action; 
	...
	led_color = simple_strtoul(argv[1], NULL, 10);
	led_action = simple_strtoul(argv[2], NULL, 10);
	led_percent = simple_strtoul(argv[3], NULL, 10);
    dm_i2c_led(led_color, led_action, led_percent);
    return 0;
}
...
static cmd_tbl_t cmd_i2c_sub[] = {
	...
	U_BOOT_CMD_MKENT(led, 4, 0, do_i2c_led, "", ""),
};
