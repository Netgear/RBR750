...
/* BDDA start, for board data offset */
#define BOARD_ID_MAX_LEN    64
#define BD_SIZE             0x20000
#define LAN_MAC_OFFSET      BOARD_ID_MAX_LEN
/* BDDA added end, for board data offset */
/* BDDA added start, for dual image */
#define ROOTFS_INFO_SIZE    0x20000
#define ROOTFS_MAGIC        0x53465452  /* 'SFTR' */
#define ROOTFS_INFO_OFFSET  4
/* Vocie_flag: without voice to indicate mode->0 (default),with voice to indicate mode ->1*/
#define CONFIG_MODE_FLAG        1
#define CONFIG_VOICE_FLAG       0
...
#define IPQ_ROOT_FS_ALT_PART_NAME	"rootfs_1" /* BDDA added for dual image */
#define IPQ_ROOT_FS_ALT_PART_NAME_2	"rootfs_2" /* BDDA added for extender image */
